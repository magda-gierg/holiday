  ...
  return knex('activity').del()
    .then(function () {
      return Promise.all([
        ...
        // Wellington
        knex('activity').insert({id: 3, name: 'Cable Car', location_id: 4}),
        knex('activity').insert({id: 3, name: 'Te Papa', location_id: 4}),
        knex('activity').insert({id: 3, name: 'Mt. Vic', location_id: 4}),
        // Dunedin
        ...
        // Mt.Ruapehu
        knex('activity').insert({id: 3, name: 'Snow Boarding', location_id: 8}),
        // Waiouru
        ...
        knex('activity').insert({id: 3, name: 'Kayaking', location_id: 10})
      ]);
    });
};
